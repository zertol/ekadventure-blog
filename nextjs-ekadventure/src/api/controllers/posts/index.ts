...
export const fetchAllPosts = async (params: Record<string, any>): Promise<ApiResult<PostType[]>> => {
...
export const fetchLatestPosts = async (params: Record<string, any>): Promise<ApiResult<PostType[]>> => {
