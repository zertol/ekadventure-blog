...
export function ClientAdWrapper({
  ...
  return (
    ...
    >
      {hasContent.isVisible && (
        <div className="w-full p-2">
          ...
          >
            ...
            {opened ? (
              <svg className={`fill-current w-4 h-4 flex-shrink-0`} viewBox="0 0 16 16">
      ...
      <div
        className={`${hasContent.isVisible && className} transition-all duration-300 ease-in-out overflow-hidden`}
        ref={containerRef}
